  ...
  return (
    <div className="min-h-screen bg-white text-black pb-20 md:pb-0">
      ...
      <div className="container mx-auto px-4 md:px-6 py-4 md:py-8 max-w-5xl">
            ...
            {items.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-200 hover:border-[#D4AF37] transition-all duration-300 shadow-md hover:shadow-lg"
                >
                  <div className="flex gap-4 md:gap-6">
                    {/* Product Image */}
                    <div className="flex-shrink-0">
                      <div className="w-24 h-24 md:w-32 md:h-32 rounded-lg overflow-hidden bg-gray-100 border border-gray-200">
                        <img
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm md:text-base text-gray-600 mb-2">
                            Quantity: <span className="text-black font-semibold">{item.quantity || 1}</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100">
                        <p className="text-base md:text-lg font-bold text-black">Item Total</p>
                        {isOutOfStock ? (
        ...
        <div className="bg-white rounded-xl md:rounded-2xl p-5 md:p-6 border border-gray-200 shadow-md hover:shadow-lg mb-6 md:mb-8 transition-shadow duration-300">
          ...
          {loadingAddress ? (
            ...
            <div className="space-y-2 text-sm md:text-base">
              <p className="text-black font-semibold">{deliveryAddress.name}</p>
            ...
            <div className="space-y-2 text-sm md:text-base">
              <p className="text-red-500">No delivery address found. Please add an address.</p>
              <button
                onClick={() => navigate('/addresses')}
        ...
        {/* Coupon Code Section */}
        <div className="bg-white rounded-xl md:rounded-2xl p-5 md:p-6 border border-gray-200 shadow-md hover:shadow-lg mb-6 md:mb-8 transition-shadow duration-300">
          <h3 className="text-lg md:text-xl font-bold text-black mb-4 md:mb-6 pb-3 md:pb-4 border-b border-gray-200 flex items-center gap-2">
            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#D4AF37]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {appliedCoupon ? (
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3 md:p-4 mb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-green-600 font-semibold">Coupon Applied: {appliedCoupon}</p>
            ...
            <div className="flex gap-2 mb-4 w-full min-w-0">
              <input
                ...
                className="flex-1 min-w-0 bg-gray-50 border border-gray-200 rounded-lg px-3 md:px-4 py-2 md:py-2.5 md:py-3 text-black placeholder-gray-500 focus:outline-none focus:border-[#D4AF37] transition-colors text-sm md:text-base"
          ...
          {availableCoupons.length > 0 && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <p className="text-xs md:text-sm text-gray-500 mb-2">Available Coupons:</p>
              <div className="flex flex-wrap gap-2">
                {availableCoupons.map((coupon) => (
                  <span
                    key={coupon._id || coupon.code}
                    className="text-xs px-2 py-1 bg-gray-100 border border-gray-200 rounded text-gray-600 cursor-pointer hover:border-[#D4AF37] transition-colors"
                    onClick={() => {
        ...
        {/* Order Summary Card */}
        <div className="bg-white rounded-xl md:rounded-2xl p-5 md:p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="space-y-3 md:space-y-4 mb-4 md:mb-6">
            <div className="flex justify-between text-sm md:text-base">
              ...
              <span className="text-black font-semibold">₹{isNaN(totalPrice) ? '0' : totalPrice.toLocaleString()}</span>
            </div>

            {appliedCoupon && (
              <div className="flex justify-between text-sm md:text-base">
                <span className="text-gray-600">Discount ({appliedCoupon})</span>
                <span className="text-green-600 font-semibold">-₹{isNaN(discount) ? '0' : discount.toLocaleString()}</span>
              </div>
            )}
            ...
            <div className="pt-3 md:pt-4 border-t border-gray-200">
              <div className="flex justify-between items-center">
                <span className="text-lg md:text-xl font-bold text-black">Total Amount</span>
