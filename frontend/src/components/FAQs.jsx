    ...
    <div className="min-h-screen bg-white text-black overflow-x-hidden pb-20 md:pb-0">
      ...
      <section className="w-full bg-white py-8 md:py-12">
        <div className="w-full">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <svg
                    className={`w-5 h-5 md:w-6 md:h-6 text-[#D4AF37] flex-shrink-0 transition-transform duration-300 ${openIndex === index ? 'rotate-180' : ''
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
          ...
          <div className="mt-8 md:mt-12 bg-white rounded-xl p-6 md:p-8 border border-gray-200 shadow-lg">
